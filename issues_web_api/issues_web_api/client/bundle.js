...
/***/ function(module, exports, __webpack_require__) {
	...
	var _universalFetch = __webpack_require__(168);

	var _universalFetch2 = _interopRequireDefault(_universalFetch);

	var _ApplicationWrapperComponent = __webpack_require__(170);

	var _ApplicationWrapperComponent2 = _interopRequireDefault(_ApplicationWrapperComponent);

	var _ApiParser = __webpack_require__(178);
	...
	function renderApp(app, parser) {
	  _reactDom2.default.render(_react2.default.createElement(
	    "div",
	    null,
	    _react2.default.createElement(_ApplicationWrapperComponent2.default, { parser: parser
	    }),
	    " "
	  ), app);
	}

	(0, _universalFetch2.default)(mainUrl).then(function (response) {
	  ...
	  renderApp(app, new _ApiParser2.default(resp));
	}).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DateRangeSearchComponent = __webpack_require__(171);

	var _DateRangeSearchComponent2 = _interopRequireDefault(_DateRangeSearchComponent);

	var _ListComponent = __webpack_require__(172);

	var _ListComponent2 = _interopRequireDefault(_ListComponent);

	var _FormComponent = __webpack_require__(173);

	var _FormComponent2 = _interopRequireDefault(_FormComponent);

	var _PaginationComponent = __webpack_require__(174);

	var _PaginationComponent2 = _interopRequireDefault(_PaginationComponent);

	var _SearchBoxComponent = __webpack_require__(175);

	var _SearchBoxComponent2 = _interopRequireDefault(_SearchBoxComponent);

	var _TagWrapperComponent = __webpack_require__(176);

	var _TagWrapperComponent2 = _interopRequireDefault(_TagWrapperComponent);

	var _ApiSearch = __webpack_require__(177);
	...
	//context indicators
	var HOME_CONTEXT = Symbol('home_page');
	var PROJECT_CONTEXT = Symbol('project_details');
	var ISSUE_CONTEXT = Symbol('issue_details');

	//class indicators
	var PROJECT_CLASS = "project";
	var ISSUE_CLASS = "issue";
	...
	*/
	...
	var ApplicationWrapper = function (_React$Component) {
	  _inherits(ApplicationWrapper, _React$Component);

	  function ApplicationWrapper(props) {
	    _classCallCheck(this, ApplicationWrapper);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ApplicationWrapper).call(this, props));
	  ...
	  */
	  ...
	  _createClass(ApplicationWrapper, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      (0, _ApiSearch.request)(this.state.parser.getAllProjectsUrl(), function (err, res) {
	        if (err) {
	          console.log(err);
	          return; //TODO
	        }
	    ...
	    */
	    ...
	    value: function onCollectionChanged(url) {
	      var _this3 = this;

	      (0, _ApiSearch.request)(url, function (err, res) {
	        if (err) {
	          console.log(err);
	          return;
	        }
	        ...
	        _this3.setState({ collection: res.collection });
	      });
	    }
	  }, {
	    key: 'onNewItemHandler',
	    value: function onNewItemHandler(url, newItemData, list) {
	      var _this4 = this;

	      (0, _ApiSearch.createNewElement)(url, newItemData, function (res) {
	        //'res' representa a resposta após tentativa de
	        // criação do recurso.
	        if (res.status === 400) {
	          //erro
	          alert(JSON.stringify(res["invalid-params"][0].reason));
	        } else _this4.onCollectionChanged(url, list);
	      });
	    }
	  }, {
	    key: 'renderTypeOfIssueBox',
	    value: function renderTypeOfIssueBox() {
	      var _this5 = this;

	      return _react2.default.createElement(
	        'div',
	        null,
	        this.state.collection.queries.map(function (elem, idx) {
	          if (elem.rel === 'filter') {
	            return _react2.default.createElement(
	              'div',
	              { key: idx, className: 'text-right' },
	                ...
	                _react2.default.createElement(
	                  'select',
	                  {
	                    onChange: function onChange(evt) {
	                      ...
	                      //change items
	                      var url = elem.href + queryPath;
	                      _this5.onCollectionChanged(url);
	                    },
	                    name: elem.name,
	    ...
	    key: 'renderSearchBoxes',
	    value: function renderSearchBoxes() {
	      var _this6 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        this.state.collection.queries.map(function (elem, idx) {
	          if (elem.rel === 'search') {
	            return _react2.default.createElement(_SearchBoxComponent2.default, {
	              key: idx,
	              onSearch: _this6.onCollectionChanged.bind(_this6),
	              queryNode: elem });
	          }
	        })
	      );
	    ...
	    key: '_onSelectedProject',
	    value: function _onSelectedProject(url) {
	      var _this7 = this;

	      (0, _ApiSearch.request)(url, function (err, sirenResourceProject) {
	        if (err) {
	          console.log(err.message);
	          return;
	        }
	        ...
	        sirenResourceProject.entities.forEach(function (obj) {
	          if (obj.class.find(function (c) {
	            return c === 'issues';
	          })) {
	            (0, _ApiSearch.request)(obj.href, function (err, issues) {
	              if (err) {
	                console.log(err.message);
	              } else {
	          ...
	          if (obj.class.find(function (c) {
	            ...
	            (0, _ApiSearch.request)(obj.href, function (err, collectionOfTags) {
	              if (err) {
	                console.log(err.message);
	                return;
	              }
	    ...
	    key: '_onSelectedIssue',
	    value: function _onSelectedIssue(url) {
	      var _this8 = this;
	      ...
	      (0, _ApiSearch.request)(url, function (err, res) {
	        ...
	        uma vez.
	        */
	        _this8._getCommentsOfIssue(res, function (err, commentsCollection) {
	          if (err) {
	            console.log(err.message);
	            return;
	          }
	    ...
	    key: 'onItemSelected',
	    value: function onItemSelected(evt) {
	      evt.preventDefault();
	    ...
	    key: 'mapListItems',
	    value: function mapListItems(item, i) {
	    ...
	    key: '_mapProjects',
	    value: function _mapProjects(item, idx) {
	      var projectName = item.data[1].value;
	      return _react2.default.createElement(
	        'strong',
	        { key: idx },
	        _react2.default.createElement(
	    ...
	    key: '_mapIssues',
	    value: function _mapIssues(item, idx) {
	      var issueName = item.data[0].value;
	      var stateOfIssue = item.data[1].value;
	      var labelClass = "pull-right ";
	      labelClass += stateOfIssue === 'open' ? "label label-success" : "label label-danger";
	    ...
	    key: '_daydiff',
	    value: function _daydiff(first, second) {
	      var miliInOneDay = 1000 * 60 * 60 * 24;
	      return Math.floor((second - first) / miliInOneDay);
	    }
	  }, {
	    key: '_mapComments',
	    value: function _mapComments(item, idx) {
	      var days = this._daydiff(this._parseDate(item.data[0].value), new Date());
	      var formatDaysMessage = function formatDaysMessage(ammount) {
	        return ammount === 0 ? "Today" : ammount + " days ago";
	      };
	      return _react2.default.createElement(
	        'div',
	        { key: idx, className: 'container' },
	        _react2.default.createElement(
	          'div',
	          { className: 'row' },
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'thumbnail' },
	              _react2.default.createElement('img', { src: 'https://ssl.gstatic.com/accounts/ui/avatar_2x.png' })
	            )
	          ),
	          _react2.default.createElement(
	            'div',
	        ...
	        _react2.default.createElement(
	          'button',
	          {
	            onClick: function onClick(evt) {
	              (0, _ApiSearch.request)(_this9.state.hrefRoot, function (err, res) {
	                if (err) {
	                  console.log(err.message);
	                } else {
	                  _this9.setState({
	    ...
	    key: '_getCommentsOfIssue',
	    value: function _getCommentsOfIssue(issue, afterGettingCommentsCb) {
	      issue.entities.forEach(function (ent) {
	        if (ent.class.find(function (c) {
	          return c === 'comments';
	        })) {
	          (0, _ApiSearch.request)(ent.href, afterGettingCommentsCb);
	        }
	      });
	    }
	  }, {
	    key: 'renderPropertiesOfResource',
	    value: function renderPropertiesOfResource() {
	      var stateOfIssue = this.state.issue.properties.state;
	      var tags = this.state.issue.properties.tags;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: stateOfIssue === "open" ? "label label-success" : "label label-danger" },
	          stateOfIssue
	        ),
	        _react2.default.createElement(
	          'div',
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.state.context === ISSUE_CONTEXT ? _react2.default.createElement(_DateRangeSearchComponent2.default, {
	          onSearch: this.onCollectionChanged.bind(this),
	          href: this.state.collection.href }) : null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'col-xs-5' },
	              this.state.issue && this.state.issue.properties.state === 'closed' ? null : _react2.default.createElement(_FormComponent2.default, {
	            ...
	            this.state.tags ? _react2.default.createElement(
	              'div',
	              { className: 'col-xs-3' },
	              _react2.default.createElement(_TagWrapperComponent2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DateRangeSearchComponent = function (_React$Component) {
	  _inherits(DateRangeSearchComponent, _React$Component);

	  function DateRangeSearchComponent(props) {
	    _classCallCheck(this, DateRangeSearchComponent);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DateRangeSearchComponent).call(this, props));

	    _this.state = {};
	    return _this;
	  }

	  _createClass(DateRangeSearchComponent, [{
	    key: '_handleOnSubmit',
	    value: function _handleOnSubmit(evt) {
	      evt.preventDefault();

	      var queryPath = [];
	      for (var p in this.state) {
	        if (this.state[p].length > 0) queryPath.push(p + '=' + this.state[p]);
	      }
	    ...
	    value: function render() {
	      ...
	      var afterLabelName = "after";
	      var beforeLabelName = "before";
	      return _react2.default.createElement(
	        'div',
	        { className: 'text-right' },
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', {
	              ...
	              className: 'form-control',
	              onChange: function onChange(evt) {
	                return _this2.setState(_defineProperty({}, afterLabelName, evt.target.value));
	              },
	              name: afterLabelName })
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', {
	              ...
	              className: 'form-control',
	              onChange: function onChange(evt) {
	                return _this2.setState(_defineProperty({}, beforeLabelName, evt.target.value));
	              },
	              id: beforeLabelName })
	          ),
	          _react2.default.createElement(
	  ...
	  return DateRangeSearchComponent;
	}(_react2.default.Component);

	exports.default = DateRangeSearchComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
					...
					return _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"b",
								null,
								"We could not find any resources to display here.."
							)
						)
					);
				}
	...
	ListComponent.propTypes = {
		...
		mapItems: _react2.default.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var FormComponent = function (_React$Component) {
	    ...
	    _createClass(FormComponent, [{
	        ...
	        value: function handleFormSubmit(evt) {
	            ...
	            template.template.data.forEach(function (obj) {
	                obj.value = obj.value ? obj.value : _this2.state[obj.name];
	                delete obj.prompt;
	            });
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.props.template.data.map(function (obj, idx) {
	                        return _react2.default.createElement(
	                            "div",
	                            { key: idx, className: obj.value ? "hidden form-group" : "form-group" },
	                            _react2.default.createElement(
	                                "label",
	                                { "for": obj.name },
	                                obj.name
	                            ),
	                            _react2.default.createElement("input", { ref: obj.name,
	                                type: "text",
	                                className: "form-control",
	                                ...
	                                name: obj.name,
	                                onChange: function onChange(evt) {
	                                    _this3.setState(_defineProperty({}, obj.name, evt.target.value));
	                                }
	                            })
	                        );
	                    }),
	...
	FormComponent.propTypes = {
	    targetSubmitHref: _react2.default.PropTypes.string.isRequired,
	    onNewItemHandler: _react2.default.PropTypes.func.isRequired,
	...
	*/
	...
	var PaginationComponent = function (_React$Component) {
		...
		function PaginationComponent() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(PaginationComponent).apply(this, arguments));
		}

		_createClass(PaginationComponent, [{
			key: '_mapNodesIntoBadges',
			value: function _mapNodesIntoBadges() {
				var _this2 = this;

				return this.props.links.map(function (obj, idx) {
					if (obj.rel === 'next') {
						return _react2.default.createElement(
							'li',
							{ key: idx, className: 'pager-next' },
							_react2.default.createElement(
								'a',
								{ onClick: function onClick(evt) {
										evt.preventDefault();
										_this2.props.onPageChange(evt.target.href);
									},
									href: obj.href },
								obj.prompt
							)
			...
			value: function render() {
				...
				var badges = this._mapNodesIntoBadges();
	...
	var SearchBox = function (_React$Component) {
		...
		_createClass(SearchBox, [{
			...
			value: function _handleOnSubmit(evt) {
				...
				var queryPath = "";
				for (var p in this.state) {
					queryPath += this.state[p].length === 0 ? '' : '&' + p + '=' + this.state[p];
				}

				//if empty, get all items
				var url = this.props.queryNode.href;
			...
			value: function _renderSearchBox(obj, idx) {
				var _this2 = this;

				return _react2.default.createElement(
					'div',
					{ key: idx, className: 'form-group' },
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement('input', {
							...
							type: 'text',
							onChange: function onChange(evt) {
								return _this2.setState(_defineProperty({}, obj.name, evt.target.value));
							},
							className: 'form-control',
							placeholder: 'Search' })
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var TagWrapperComponent = function (_React$Component) {
		_inherits(TagWrapperComponent, _React$Component);

		function TagWrapperComponent() {
			_classCallCheck(this, TagWrapperComponent);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(TagWrapperComponent).apply(this, arguments));
		}

		_createClass(TagWrapperComponent, [{
			key: "render",
			value: function render() {
				var _this2 = this;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_ListComponent2.default, {
						...
						mapItems: function mapItems(item, idx) {
							return _react2.default.createElement(
								"strong",
								{ key: idx },
								_react2.default.createElement(
					...
					_react2.default.createElement(_FormComponent2.default, {
						...
						onNewItemHandler: function onNewItemHandler(url, newItem) {
							return _this2.props.onNewItemHandler(url, newItem, 'tags');
						} })
				);
			}
		}]);
	...
	exports.default = TagWrapperComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function request(url, cb) {
		var self = this;
		(0, _universalFetch2.default)(url).then(function (response) {
			if (response.status >= 400) {
				//TODO
				console.log("ERROR:\n" + response.body);
	...
	function createNewElement(url, template, cb) {
		...
		(0, _universalFetch2.default)(url, {
			...
			return console.log("Network failure. " + err.message);
		});
	}
...
/***/ function(module, exports) {
	...
	ApiParser.prototype.getAllIssuesUri = function (projName) {
		return this.resourcesUris.issues_url.replace("{" + this.relations.projectName + "}", "" + projName).split("{/" + this.relations.issuesID + "}")[0];
	};
